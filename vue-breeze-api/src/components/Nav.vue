    ...
    <div>
      <nav class="flex h-9 items-center justify-between" aria-label="Global">
        <div class="flex lg:min-w-0 lg:flex-1" aria-label="Global">
          <router-link :to="{name: 'Home'}" class="font-semibold text-gray-900 hover:text-gray-900">
        ...
        <div class="hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-center lg:gap-x-12" v-if="authStore.user">
          <router-link :to="{name: 'Home'}" class="font-semibold text-gray-900 hover:text-gray-900">Home</router-link>
          <button @click="authStore.handleLogout" class="font-semibold text-gray-900 hover:text-gray-900">
            Logout
          </button> 
        </div> 
        <div class="hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-center lg:gap-x-12" v-else>  
          <router-link :to="{name: 'Home'}" class="font-semibold text-gray-900 hover:text-gray-900">Home</router-link>
          <router-link :to="{name: 'Login'}" class="font-semibold text-gray-900 hover:text-gray-900">Login</router-link> 
          <router-link :to="{name: 'Register'}" class="font-semibold text-gray-900 hover:text-gray-900">Register</router-link>
        </div> 
